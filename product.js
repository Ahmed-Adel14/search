...
const productcategpry = new URLSearchParams(window.location.search).get("category")

const hhhhh = products.find((product) => {
  return  product.category===productcategpry
})
if (hhhhh) {
    document.body.innerHTML = hhhhh.category;
} else {
    document.body.innerHTML = "لم يتم العثور على منتج";
}